function [ x, y, z, time, sampleRate ] = ParseAccMPU9( filename, timeZone )
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% MPU9 9DoF motion sensor's Accelerometer.
% 
...
%
% Returns:
% x,y,z - vectors containing timeseries samples of the accelerometer
% (x,y,z)
% time - vestor containing the time of individual samples
% sampleRate - calculated effective sampling rate

    fid = fopen(filename);
    data = fread(fid, [3, inf], '3*int16=>double', 26, 'ieee-be');
    fclose(fid);
